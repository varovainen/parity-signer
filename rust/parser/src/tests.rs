...
fn tr_1() {
    ...
    let reply =
        parse_and_display_set(&mut data, &metadata("for_tests/westend9111"), &specs()).unwrap();
    let reply_known = r#"
Method:
...
fn tr_2() {
    let mut data = hex::decode("").unwrap();
    let reply =
        parse_and_display_set(&mut data, &metadata("for_tests/westend9120"), &specs()).unwrap_err();
...
fn tr_5() {
    ...
    let reply =
        parse_and_display_set(&mut data, &metadata("for_tests/westend9122"), &specs()).unwrap();
    let reply_known = "
Method:
...
fn tr_6() {
    ...
    let reply =
        parse_and_display_set(&mut data, &metadata("for_tests/acala2012"), &specs_acala).unwrap();
    let reply_known = r#"
Method:
